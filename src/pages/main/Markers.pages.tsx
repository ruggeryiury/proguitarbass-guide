        ...
        <MainComponent title="Hammer-Ons & Pull-Offs" anchors={PageAnchorsProvider('hopo')}>
            <Paragraph>
                ...
                <ul>
                    ...
                    <List title="Forcing HO/PO Notes On">You can force notes to be HO/PO notes by using the <strong className="text-cyan-500">FORCE HO/PO MARKER</strong> <Block>F♯6</Block> (102) (for Expert difficulty). Like on 5-lane guitar/bass/keys, you can force HO/PO on with multiple notes in a row as well, just place a marker encopassing all the notes you want to be displayed as HO/PO.</List>
...
export const StringEmphasis = () => {
    return (
        <MainComponent title='String Emphasis' anchors={PageAnchorsProvider('string-emphasis')}>
            <Paragraph>
