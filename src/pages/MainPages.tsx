...
export const Index = () => {
  ...
  return (
    <MainComponent config={config}>
      ...
      />
      <Paragraph>
        This guide will help you creating PRO Guitar/Bass parts for your customs, with every single PRO mode features explained.
        <br />
        <br />
        Here are some things you should consider before authoring PRO Guitar/Bass parts:
      </Paragraph>
      ...
      <ul>
        <Link
          to="https://rhythmgamingworld.com/forums/topic/pro-guitar-preview-for-reaper-v10/"
          title="PRO Guitar Preview Plugin for REAPER"
        >
          A REAPER JSFX plugin created by C3 user <em>Seil</em> that translates PRO Guitar/Bass notes to actual MIDI notes, so you can use any VST plugin (like REAPER's <em>ReaSynth</em>) to hear the notes you're charting.
        </Link>
        <Link
          to="/proguitarbass-guide/static/REAPERNoteNames.zip"
          title="PRO Guitar/Bass note names for REAPER"
        >
          Including two text files for you to use on your PRO Guitar/Bass tracks on REAPER, one has note names for all difficulties and the other has just for Expert difficulty.
        </Link>
        <Link
          to="https://code.google.com/archive/p/ziggy-pro-editor/"
          title="Ziggy's PRO Editor"
        >
          Since CAT can't do automatic PRO Guitar/Bass reductions, <em>Ziggy's PRO Editor</em> might be handy tool for you to auto-generate EMH difficulties in a flash! You can find a tutorial to generate reductions on the <Href href="/reductions">Reductions</Href> page.
        </Link>
      </ul>
      ...
      <ol className="list-decimal">
        <List
          title="Install PRO Guitar Preview, and the PRO Guitar/Bass note names"
          decimal
        >
        ...
        <List
          title="Create PRO Guitar/Bass tracks"
          decimal
        >
      ...
      >
        <List
          title="Load PRO Guitar/Bass note names"
          decimal
        >
        ...
        <List
          title="Place the notes color based on the MIDI channel"
          decimal
        >
        ...
        <List
          title="Configure the PRO Guitar Preview FX"
          decimal
        >
...
export const Notes = () => {
  ...
  return (
    <MainComponent config={config}>
      <Paragraph>You must handle with two basic things while authoring PRO Guitar/Bass notes, that are the strings and frets.</Paragraph>

      <Title
        index={0}
        config={config}
      />
      <Paragraph>To determine the strings of a note, we use these MIDI notes:</Paragraph>
      <ul className="list-disc">
        <Options>
          From <Block>C6</Block> (96) to <Block>F6</Block> (101) for Expert difficulty.
        </Options>
        <Options>
          From <Block>C4</Block> (72) to <Block>F4</Block> (77) for Hard difficulty.
        </Options>
        <Options>
          From <Block>C2</Block> (48) to <Block>F2</Block> (53) for Medium difficulty.
        </Options>
        <Options>
          From <Block>C0</Block> (24) to <Block>F0</Block> (29) for Easy difficulty.
        </Options>
      </ul>
...
export const Chords = () => {
  ...
  return (
    <MainComponent config={config}>
      <Paragraph>A chord is a group of notes sounded together, as a basis of harmony. On Rock Band 3, they're displayed as blue shapes, displaying only the lower note of a chord on its string and creating a shape based on it. Open notes will be displayed as white.</Paragraph>
      ...
      <Title
        ...
        config={config}
      />
      <Paragraph>For chords with any muted string in-between, you must omit the muted string. If you encode a single string mute on a chord, the whole chord will appear muted in-game.</Paragraph>
      ...
      />
      <Paragraph>
        The <strong className="text-cyan-500">SHARP/FLAT SWAP MARKER</strong> <Block>F♯-1</Block> (18) is used to change the accident symbols used on chords. The default accident symbol used on chords is based on the song's key signature and tonality (that is defined on the song's .dta file) and it follows the{' '}
        <a
          href="https://en.wikipedia.org/wiki/Circle_of_fifths"
          target="_blank"
          rel="noreferrer"
          className="tracking-tight inline-flex text-cyan-500 hover:underline"
        >
          circle of fifths
        </a>{' '}
        theory, but when song key changes in the middle of the song, the <strong className="text-cyan-500">SHARP/FLAT SWAP MARKER</strong> should be used to fit the symbol used on that specific key.
        <br />
        <br />
...
export const LeftHandPosition = () => {
  ...
  return (
    <MainComponent config={config}>
      ...
      />
      <img
        src={IndexFingerExampleImg}
        alt="Left Hand Position Note explained"
        width="1266px"
        height="620px"
        className="hidden tablet-md:flex mb-4"
      />
      <img
        src={IndexFingerExampleImgMobile}
        alt="Left Hand Position Note explained"
        width="1266px"
        height="620px"
        className="flex tablet-md:hidden mb-4"
      />
      <Paragraph>
    ...
    <MainComponent config={config}>
      ...
      <ul className="list-disc">
        ...
        <List title="Forcing HO/PO Notes On">
          You can force notes to be HO/PO notes by using the <strong className="text-cyan-500">HO/PO MARKER</strong> <Block>F♯6</Block> (102) (for Expert difficulty). Like on 5-lane guitar/bass/keys, you can force HO/PO on with multiple notes in a row as well, just place a marker encopassing all the notes you want to be displayed as HO/PO.
        </List>
        <List title="Forcing HO/PO Notes Off">
          You can force notes NOT to be HO/PO notes by using the <strong className="text-cyan-500">HO/PO MARKER</strong> <Block>F♯6</Block> (102) (for Expert difficulty) encoded on <Block bg="#758c5e">MIDI CHANNEL 13</Block>. Forcing HO/PO off is useful for songs with slow BPMs (100BPM or lower), since 1/16th note sequences aren't fast enough to avoid strumming. On songs with higher BPMs, it must be used sparingly and with conscience, since it can make the song unfairly harder to play.
        </List>
      </ul>
    </MainComponent>
  )
...
export const Slide = () => {
  ...
  return (
    <MainComponent config={config}>
      ...
      <Paragraph>
        <em>
          Old tutorials believed that slide directions was based on the <strong className="text-cyan-500">SLIDE MARKER</strong> velocity, but they couldn't explain why some notes didn't respect that rule, with the slide going to the opposite direction that is was intended to go.
        </em>
        <br />
        <br />
      ...
      <ul className="list-disc">
        <Options>
          The <span className="text-cyan-500">FRET</span> rule, by default.
        </Options>
        <Options>
          The <span className="text-cyan-500">1/16 NOTE GAP</span> rule.
        </Options>
      </ul>
  ...
  return (
    <MainComponent config={config}>
      <Paragraph>
        ...
        <br />
        <br />
        Any note/chord fragment that is compatible with the chord of the <strong className="text-cyan-500">ARPEGGIO MARKER</strong> are displayed as turquoise notes on every string. There are two main concepts of using the <strong className="text-cyan-500">ARPEGGIO MARKER</strong>:
      </Paragraph>
      <ul className="list-disc">
  ...
  return (
    <MainComponent config={config}>
      ...
      <ul className="list-disc">
        <Options>
          {' '}
          <Block bg="#5e8c7b">MIDI CHANNEL 14</Block> to emphasize higher strings.{' '}
        </Options>
        <Options>
          {' '}
          <Block bg="#5e698c">MIDI CHANNEL 15</Block> to emphasize middle strings.{' '}
        </Options>
        <Options>
          {' '}
          <Block bg="#875e8c">MIDI CHANNEL 16</Block> to emphasize lower strings.{' '}
        </Options>
      </ul>
    </MainComponent>
  )
...
export const NoteEncodings = () => {
  ...
  return (
    <MainComponent config={config}>
      <Paragraph>All PRO Guitar/Bass functions are encoded using markers and channel encodings. Here is all possible channel encodings and their respective uses.</Paragraph>
...
export const TrainerSections = () => {
  ...
  return (
    <MainComponent config={config}>
      <Paragraph>Trainer sections are authored as text events. These text events must be placed on the 17-fret tracks only.</Paragraph>
...
export const Tunings = () => {
  ...
  return <MainComponent config={config}></MainComponent>
}
  ...
  return (
    <MainComponent config={config}>
      ...
      <Title
        ...
        config={config}
      />
      <Paragraph>Hard should be a slightly reduced version of Expert (for example, removing HOPOs, or reducing number of notes played in particularly fast parts of soloes.) If you need further guidance on reducing your Expert pro chart to Hard, it's surprisingly useful to use the Hard 5-lane guitar chart as a base.</Paragraph>

      <Title
        index={2}
        config={config}
      />
      <Paragraph>Medium is a significantly more reduced version of the original Expert chart. Chords are still allowed, but generally only the first two strings In general, you want to stick to around 1 note/chord every other beat (so in a 4/4 time measure, there would be two notes/chords around beats 1 and 3). However, if a song has a long streak of singular notes (i.e. the latter part of Uncontrollable Urge on bass), you can usually get away with having one note/chord per beat - do whatever feels right based on the song.</Paragraph>

      <Title
        index={3}
        config={config}
      />
      <Paragraph>Easy has zero chords whatsoever - reduce any chords down to their root note. In addition to this, while on Medium you generally want to stick to 1 note/chord every other beat, on Easy you halve this to 1 note/chord every 4 beats (so in 4/4 time, each measure would have one note on beat 1). It should be noted that there are obviously exceptions to this rule, such as if a song is in a time signature greater than 4/4. In this case, having two notes spaced apart evenly per measure would be acceptable. Like Medium, if a song has a long streak of singular notes, you can get away with doubling the frequency that notes appear in each measure; again, do what feels right based on the song.</Paragraph>
    </MainComponent>
  )
}
  ...
  return (
    <MainComponent config={config}>
      ...
      <Window
        title={
          <span>
            Gem at <Block measure /> in easy/medium/hard/expert difficulty has no slots
          </span>
        }
      >
      ...
      <Window
        title={
          <span>
            MIDI note <Block>108</Block> at <Block measure /> has invalid velocity ???
          </span>
        }
      >
      ...
      <Window
        title={
          <span>
            No root note set for gem at <Block measure />
          </span>
        }
      >
      ...
      <Window
        title={
          <span>
            No left hand position set for gem at <Block measure />
          </span>
        }
      >
        <strong>
          No <Href href="/left-hand-position">Left Hand Position note(s)</Href> were found before or aligned to the specified gem
        </strong>
        . Left Hand Position notes must be properly charted for MAGMA to compile the song.
      </Window>
      <Window
        title={
          <span>
            Fret is less than left hand position on gem at <Block measure />
          </span>
        }
      >
        The specified gem has{' '}
        <strong>
          lower velocity than the declared <Href href="/left-hand-position">Left Hand Position note</Href> before or aligned to it
        </strong>
        .
      </Window>
      <Window
        title={
          <span>
            Fret is too far away from left hand position on gem at <Block measure />
          </span>
        }
      >
        The specified gem velocity is{' '}
        <strong>
          too high for the declared <Href href="/left-hand-position">Left Hand Position note</Href> before or aligned to it
        </strong>
        .
      </Window>
      ...
      <Window
        title={
          <span>
            Overdrive phrase at <Block>[XX:X:XXX-XX:X:XXX]</Block> for guitar/bass but not real_guitar/real_bass
          </span>
        }
      >
      ...
      <Window
        title={
          <span>
            Real Guitar On Midi Message out of range at tick <Block measure /> with pitch 124/125
          </span>
        }
      >
